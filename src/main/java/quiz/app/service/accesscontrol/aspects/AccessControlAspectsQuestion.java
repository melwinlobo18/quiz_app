...
public class AccessControlAspectsQuestion {
	...
	@Around("execution(* quiz.quiz_app.repository.QuestionRepository.save(..)) && args(question)")
	...
	@Around("execution(* quiz.quiz_app.repository.QuestionRepository.find(Long)) && args(id)")
	...
	@Around("execution(* quiz.quiz_app.repository.QuestionRepository.findAll())")
	...
	@Around("execution(* quiz.quiz_app.repository.QuestionRepository.delete(..)) && args(question)")
