package quiz.quiz_app.unitTests.service;
...
import quiz.quiz_app.exceptions.ActionRefusedException;
import quiz.quiz_app.exceptions.QuizAppException;
...
import quiz.quiz_app.repository.QuestionRepository;
import quiz.quiz_app.service.AnswerService;
import quiz.quiz_app.service.QuestionService;
import quiz.quiz_app.service.QuestionServiceImpl;
...
public class QuestionServiceTests {
	...
	@Test
	public void testUpdateShouldUpdate() throws QuizAppException {
	...
	@Test
	public void testUpdateShouldUpdate_noOrder() throws QuizAppException {
		question.setText("test");
	...
	@Test(expected = ResourceUnavailableException.class)
	public void testUpdateUnexistentQuestion() throws QuizAppException {
		question.setText("test");
	...
	public void testUpdateFromWrongUser() throws QuizAppException {
		question.setText("test");
	...
	@Test
	public void testDelete_QuizIsNotPublished_ShouldDelete() throws QuizAppException {
	...
	@Test
	public void testDelete_IsInvalid_ShouldDelete() throws QuizAppException {
	...
	@Test
	public void testDelete_SeveralValidQuestions_ShouldDelete() throws QuizAppException {
		question.getQuiz().setIsPublished(true);
	...
	public void testDelete_SeveralValidQuestions_ShouldntDelete() throws QuizAppException {
		question.getQuiz().setIsPublished(true);
		question.setIsValid(true);
	...
	@Test(expected = UnauthorizedActionException.class)
	public void testDeleteFromWrongUser() throws QuizAppException {
